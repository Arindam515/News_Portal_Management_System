                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="role" value="<?php echo $row['role']; ?>">
                            ...
                            <?php 
                                ...
                                echo  "<option value='1'>Publisher</option>";
                                echo  "<option value='2'>Journalist</option>";
                                ...
                                echo   "<option value='0' selected> Admin</option>";
                                  ...
                                  elseif($row['role'] == 1){
                                    ...
                                    echo  "<option value='1'selected >Publisher</option>";
                                    echo  "<option value='2'>Journalist</option>";
                                    echo  "<option value='3'>User</option>";
                                  ...
                                  elseif($row['role'] == 2){
                                    ...
                                    echo  "<option value='2' selected >Journalist</option>";
                                    echo  "<option value='3'>User</option>";
                                    echo  "<option value='0'>Admin</option>";
                                    echo  "<option value='1'>Publisher</option>";
