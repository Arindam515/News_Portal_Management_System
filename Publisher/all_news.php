<?php 
include "header.php"; 
// include 'controllers/backend-search.php';
?>
...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("controllers/backend-search.php", {term: inputVal}).done(function(data){
  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading"> <b>#All News<b> </h1>
...
?>
                          <tr>
                              ...
                              <td><img height="50px" src="../uploads/<?php echo $row['post_img'] ?>"></td>
...
<td class='delete'>
  <a onclick="return confirm('Are You Sure?')" href='delete-post.php?id=<?php echo $row['post_id'] ?>&catid=<?php echo $row['category'] ?>'>
